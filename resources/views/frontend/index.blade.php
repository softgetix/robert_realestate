@include('frontend.common.header')
        ...
        <!-- Home -->
        <section class="home-height-half bg-home bg-home-img" id="home">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="service-boxed">
                            <img src="{{asset('front/images/icons/svg/Chart.svg')}}" alt="service-icon-img" class="service-icon" />
                    ...
                    <div class="col-lg-4">
                        <div class="service-boxed">
                            <img src="{{asset('front/images/icons/svg/Rainumbrella.svg')}}" alt="service-icon-img" class="service-icon" />
                            <div class="service-body">
                    ...
                    <div class="col-lg-4">
                        <div class="service-boxed">
                            <img src="{{asset('front/images/icons/svg/Dollarbag.svg')}}" alt="service-icon-img" class="service-icon" />
                            <div class="service-body">
                                <h5>Communication</h5>
                                <p>
                                    Lorem ipsum dolor sit amet consectetuer adipiscing elit, Aenean/ commodo ligula eget dolor Aenean elight massa.
        ...
        <section class="section bg-light" id="features">
            <div class="container">
                ...
                <div class="row vertical-content justify-content-center pb-4">
                    <div class="col-lg-6">
                        <div>
                            <img src="{{asset('front/images/icons/svg/Moviecam.svg')}}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row vertical-content mt-4 justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div>
                            <img src="{{asset('front/images/icons/svg/Paperdesk.svg')}}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                </div>    
            </div>
                ...
                <div class="row vertical-content ">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="video-play-bar">
                            ...
                            <img src="{{asset('front/images/Mac-Display-Mockup.jpg')}}" alt="" class="img-fluid mx-auto d-block">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="team">
                            <div class="item">
                                <div class="team-box">
                                    <img src="{{asset('front/images/team/team-1.jpg')}}" alt="" class="img-fluid team-img">
                                    <div class="team-info">
                            ...
                            <div class="item">
                                <div class="team-box">
                                    <img src="{{asset('front/images/team/team-3.jpg')}}" alt="" class="img-fluid team-img">
                                    <div class="team-info">
                                        <div class="text-center">
                            ...
                            <div class="item">
                                <div class="team-box">
                                    <img src="{{asset('front/images/team/team-5.jpg')}}" alt="" class="img-fluid team-img">
                                    <div class="team-info">
                                        <div class="text-center">
                            ...
                            <div class="item">
                                <div class="team-box">
                                    <img src="{{asset('front/images/team/team-2.jpg')}}" alt="" class="img-fluid team-img">
                                    <div class="team-info">
                                        <div class="text-center">
                            ...
                            <div class="item">
                                <div class="team-box">
                                    <img src="{{asset('front/images/team/team-4.jpg')}}" alt="" class="img-fluid team-img">
                                    <div class="team-info">
                                        <div class="text-center">
            ...
            <div class="container">
                ...
                <div class="row vertical-content">
                    ...
                    <div class="col-lg-6 col-md-12 pl-0 pr-0">
                        <img src="{{asset('front/images/macbook.png')}}" alt="" class="img-fluid m-l-auto">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-8 owl-carousel owl-theme" id="owl-demo">
                        <div class="item">
                            <div class="p-3 text-center testimonial-box">
                                <div class="testi-img">
                                    <img src="{{asset('front/images/users/user-1.jpg')}}" alt="" class="img-fluid mx-auto d-block rounded-circle">
                                </div>
                        ...
                        <div class="item">
                            <div class="p-3 text-center testimonial-box">
                                <div class="testi-img">
                                    <img src="{{asset('front/images/users/user-2.jpg')}}" alt="" class="img-fluid mx-auto d-block rounded-circle">
                                </div>
                                <p class="testi-rate mt-2 mb-1">
                                    <i class="mdi mdi-star text-warning"></i>
                                    <i class="mdi mdi-star text-warning"></i>
                        ...
                        <div class="item">
                            <div class="p-3 text-center testimonial-box">
                                <div class="testi-img">
                                    <img src="{{asset('front/images/users/user-3.jpg')}}" alt="" class="img-fluid mx-auto d-block rounded-circle">
                                </div>
                                <p class="testi-rate mt-2 mb-1">
                                    <i class="mdi mdi-star text-warning"></i>
                                    <i class="mdi mdi-star text-warning"></i>
                ...
                <div class="row">
                    <div class="col-lg-2">
                        <div class="client-images">
                            <img src="{{asset('front/images/clients/1.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                        </div>
                    </div>
                    <!-- slider item -->
                    <div class="col-lg-2">
                        <div class="client-images">
                            <img src="{{asset('front/images/clients/2.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                        </div>
                    </div>
                    <!-- slider item -->
                    <div class="col-lg-2">
                        <div class="client-images">
                            <img src="{{asset('front/images/clients/3.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                        </div>
                    </div>
                    <!-- slider item -->
                    <div class="col-lg-2">
                        <div class="client-images">
                            <img src="{{asset('front/images/clients/4.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                        </div>
                    </div>
                    <!-- slider item -->
                    <div class="col-lg-2">
                        <div class="client-images">
                            <img src="{{asset('front/images/clients/5.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                        </div>
                    </div>
                    <!-- slider item -->
                    <div class="col-lg-2">
                        <div class="client-images">
                            <img src="{{asset('front/images/clients/6.png')}}" alt="logo-img" class="mx-auto img-fluid d-block">
                        </div>
                    </div>
                    <!-- slider item -->
                </div>
