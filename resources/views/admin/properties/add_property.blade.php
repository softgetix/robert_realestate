                            ...
                            <div class="card-body">
                                ...
                                <form class="row needs-validation" action="{{ route('manage-property.store') }}"
                                    ...
                                    <!-- <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="bedrooms"
                                                                id="example-text-input">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="half_baths"
                                                                id="example-text-input">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="sleeps"
                                                                id="example-text-input">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="garage"
                                                                id="example-text-input">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="sqft"
                                                                id="example-text-input">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="stories"
                                                                id="example-text-input">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="lot_size"
                                                                id="example-text-input">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Market
                                            Title</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" required type="text" name="market_title"
                                                id="example-text-input">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Documents
                                            1</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="file" required name="images[]"
