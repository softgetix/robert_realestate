                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="row needs-validation"
                                    action="{{ route('manage-property.update', ['manage_property' => $property_id]) }}"
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <select class="form-control" name="availability" id="availability">
                                                ...
                                                <option value="Available"
                                                    {{ $property->availability == 'Available' ? 'selected' : '' }}>Available
                                                </option>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $property->name ?? old('name') }}"
                                                required type="text" name="name" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="file" name="property_images[]"
                                                accept="image/*" id="example-text-input" multiple>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control"
                                                value="{{ $property->management_company ?? old('management_company') }}"
                                                required type="text" name="management_company" id="example-text-input">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Description</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" required name="description"> {{ $property->description ?? old('description') }}</textarea>
